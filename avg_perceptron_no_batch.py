...
class Classifier:
    ...
    #             for i in train_exam_list[idx].word_index:
    #                 self.weight_array[i] += np.subtract(train_exam_list[idx].label_index, y)
    #                 self.average_w_array[i] += (ele /deno) *np.subtract(train_exam_list[idx].label_index, y)
    #                 self.bias += np.subtract(train_exam_list[idx].label_index, y)
    #             if self.get_max_index(y) == train_exam_list[idx].max_label_num:
    #                 corrects += 1
    #             sum += 1
    #             ele -= 1
    #         print(corrects/ sum)
    ...
    #             pd_l_for_y = np.subtract(train_exam_list[idx].label_index, y)
    #             for i in train_exam_list[idx].word_index:
    #                 self.weight_array[i] += pd_l_for_y
    #                 self.bias += pd_l_for_y
    #                 self.average_w_array[i] += (ele / deno) * pd_l_for_y
